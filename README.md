...
8) Installed Docker and Portainer (I'll be using Portainer web UI to manage Docker containers):
    ...
    ```
9) With [this Docker compose file](#https://github.com/garamchai2000/RPi2-ModelB-1GB-RAM/blob/main/docker-compose.yaml) loaded as stack in Portainer (and environment variables from [rpi2gb.env](#rpi2gb.env)), I now have this running on my Pi:
